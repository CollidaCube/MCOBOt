package com.collidacube.bot.data.event;
...
public class Event extends DataPackage<Event> {
    ...
    public static final DataManager<Event> DATA_MANAGER = new DataManager<>(Event.class, Event::loadFrom, Bot.bot.dataPath + "Events.db",
                                                                "label",
                                                                "code",
                                                                "channelId");
